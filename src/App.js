...
const style = {
  ...
  // input: `p-2 pl-4 w-full text-xl bg-white text-[#14213d] rounded outline-none`,
  input: `p-2 pl-4 w-full text-xl border-b-2 border-white bg-transparent text-white outline-none`,
  button: `p-2 ml-2 text-white`,
  count: `text-center p-2 text-white`,
  socials: `animate-pulse cursor-pointer flex justify-center items-center pt-7 space-x-8 text-2xl text-[#ffffff]`,
}
